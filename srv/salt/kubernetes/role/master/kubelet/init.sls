...
/etc/systemd/system/kubelet.service:
    file.managed:
    - source: salt://kubernetes/role/master/kubelet/templates/kubelet.service.jinja
    - user: root
    - template: jinja
    - group: root
    - mode: 644
...
/etc/kubernetes/kubelet.kubeconfig:
    file.managed:
    - source: salt://kubernetes/role/master/kubelet/templates/kubelet.kubeconfig.jinja
    - user: root
    - template: jinja
    - group: root
    - mode: 644
...
/etc/kubernetes/bootstrap.kubeconfig:
    file.managed:
    - source: salt://kubernetes/role/master/kubelet/templates/bootstrap.kubeconfig.jinja
    - user: root
    - template: jinja
    - group: root
    - mode: 644
...
/var/lib/kubelet/kubelet-config.yaml:
  file.managed:
    ...
    - source: salt://kubernetes/role/master/kubelet/templates/kubelet-config.yaml.jinja
    - user: root
    - template: jinja
    - group: root
    - mode: 644
...
kubelet-service-reload-daemon:
  module.run:
    ...
    - watch: /etc/systemd/system/kubelet.service

kubelet.service:
  service.running:
    - watch:
      - module: kubelet-service-reload-daemon
