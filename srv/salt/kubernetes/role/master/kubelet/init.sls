...
/etc/systemd/system/kubelet.service:
    file.managed:
    - source: salt://kubernetes/role/master/kubelet/templates/kubelet.service.j2
    - user: root
    - template: jinja
    - group: root
    - mode: 644
...
/etc/kubernetes/kubelet.kubeconfig:
    file.managed:
    - source: salt://kubernetes/role/master/kubelet/templates/kubelet.kubeconfig.j2
    - user: root
    - template: jinja
    - group: root
    - mode: 644
...
/etc/kubernetes/bootstrap.kubeconfig:
    file.managed:
    - source: salt://kubernetes/role/master/kubelet/templates/bootstrap.kubeconfig.j2
    - user: root
    - template: jinja
    - group: root
    - mode: 644
