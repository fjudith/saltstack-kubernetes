...
curl -fsSL https://repo.saltproject.io/py3/ubuntu/22.04/amd64/archive/${SALT_VERSION}/SALTSTACK-GPG-KEY.pub | sudo apt-key add - && \
echo "deb https://repo.saltproject.io/py3/ubuntu/22.04/amd64/archive/${SALT_VERSION} jammy main" > /etc/apt/sources.list.d/saltstack.list && \
